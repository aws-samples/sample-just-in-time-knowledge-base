...
/**
 * RefreshIcon component - A vector-based refresh icon
 * 
 * @param {Object} props - Component props
 * @param {string} props.color - Icon color (default: '#0066cc')
 * @param {number} props.size - Icon size in pixels (default: 20)
 * @param {Object} props.style - Additional style properties
 * @returns {JSX.Element} SVG refresh icon
 */
function RefreshIcon({ color = '#0066cc', size = 20, style = {} }) {
  return (
    <svg 
      width={size} 
      height={size} 
